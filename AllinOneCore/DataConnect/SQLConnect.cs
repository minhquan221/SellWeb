...
{
    internal class SQLConnect : Data, IData
    {
        ...
        public SQLConnect(string strConnect)
        {
            this.objConnection = null;
            this.objCommand = null;
            this.objTransaction = null;
        ...
        public bool Connect()
        {
            if (!this.IsConnected())
            {
                ...
                {
                    this.objConnection = new SqlConnection(Data.Decrypt(base.strConnect, "25251325@gmail.com"));
                }
        ...
        private SQLConnectAdapter SetDataAdapter(SqlCommand objCommand)
        {
            return new SQLConnectAdapter(objCommand);
        }

        private SQLConnectAdapter SetDataAdapter(string strSQL)
        {
            return new SQLConnectAdapter(strSQL, this.objConnection);
        }
